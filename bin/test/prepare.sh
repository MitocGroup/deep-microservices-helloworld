...
npm install -g browserify@13.0.x &&\
npm install -g jscs@3.0.x &&\
npm install -g mocha@2.4.x &&\
npm install -g codacy-coverage@1.1.x &&\
npm install -g chai@3.5.x &&\
npm install -g jasmine-core@2.4.x &&\
npm install -g istanbul@0.4.x &&\
npm install -g istanbul-combine@0.3.x &&\
npm install -g karma@0.13.x &&\
npm install -g karma-jspm@2.1.x &&\
npm install -g karma-jasmine@0.3.x &&\
npm install -g karma-babel-preprocessor@6.0.x &&\
npm install -g karma-coverage@douglasduteil/karma-coverage#next &&\
npm install -g karma-verbose-reporter@0.0.x &&\
npm install -g karma-phantomjs-launcher@1.0.x &&\
npm install -g karma-ng-html2js-preprocessor@0.2.x &&\
npm install isparta@4.0.x &&\
